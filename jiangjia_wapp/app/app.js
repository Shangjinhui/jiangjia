...
switch (hostType) {
  case 1: //正式
    host = 'https://www.jinqiushao.com/';
    api = host + 'index.php/api/';
    api1 = host + 'index.php/web/';
    imgUrl = host + 'wapp/';
    break;
  case 2: //测试
    host = 'https://demo2.yunmofo.cn/JJ_football/';
    api = host +'index.php/api/';
    api1 = host + 'index.php/web/';
    imgUrl = host + 'wapp/';
    // imgUrl = '../../img/';
...
App({
  ...
  onLaunch(res) {
    ...
    // wx.setStorageSync('Token', 'Ny10fDGaW6Ni7IMJ33MgppwPReNUHCdi5KnRwE2g7epg63SDFs+Lgv1QwTeeL3u7');
